...
def process_files():
    try:
        ...
        elif method == 'process_method2':
            return process_method2(request)
        else:
...
def process_method2(request):
    # Implement method2 processing
    # This method might require different files and parameters
    pass

def process_method3(request):
    # Implement method3 processing
    # This method might require different files and parameters
    pass
